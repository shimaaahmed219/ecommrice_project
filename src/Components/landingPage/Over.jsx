...
export default function Over() {
  const rows =[
    {
      "id": 1,
      "title": "Over 80% below retail price",
      "images": [
        {
          "id": 1,
        ...
        {
          "id": 3,
          "url": "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTPjgmlfVXfFxA8kjIQaNjJoHGZLbd7KArlyw&usqp=CAU",
          "title": "Image 3",
          "price": "30.99"
        }
      ]
    ...
    {
      "id": 2,
      "title": "Spotlight on other savings",
      "images": [
        {
          "id": 4,
